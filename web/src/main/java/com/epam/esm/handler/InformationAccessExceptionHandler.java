...
@ControllerAdvice
public class InformationAccessExceptionHandler {
    private final HttpStatus status = HttpStatus.BAD_REQUEST;

    @ExceptionHandler(InformationAccessException.class)
    public final ResponseEntity<ExceptionResponse> handleRuntimeExceptions(InformationAccessException e,
